...
```{r}
x = generate_interaction_string(c('Test', 'Test1', 'Test3'))
x
#helper functions
...
experiment_columns = c('BusinessTravel','EducationField','EnvironmentSatisfaction', 'OverTime', 'Gender', 'HourlyRate', 'JobInvolvement', 'JobLevel', 'MaritalStatus', 'NumCompaniesWorked', 'PerformanceRating', 'JobRole', 'Age')

experiment_interactions = c('HourlyRate:OverTime', 'JobInvolvement:JobLevel:OverTime')
run_linear_model(attrition_data, experiment_target, experiment_columns, experiment_interactions)
run_nn_model(attrition_data, experiment_target, experiment_columns, experiment_interactions)
```
