...
```{r}
target = c('Attrition')
columns = c('BusinessTravel','Department','EducationField', 'OverTime', 'Gender', 'HourlyRate', 'JobInvolvement', 'JobLevel', 'MaritalStatus', 'NumCompaniesWorked', 'PerformanceRating')
